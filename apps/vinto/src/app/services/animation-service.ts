...
export class AnimationService {
  ...
  handleStateUpdate(
    ...
    if (oldState.phase === 'setup' && newState.phase === 'playing') {
      console.log('[AnimationService] Setup phase ended, clearing temporary visible cards');
  ...
  private handleDiscardCard(
    ...
    const discardedCard = newState.discardPile[0];
  ...
  private handleSwapCard(
    ...
    const oldCard = newState.discardPile[0];
  ...
  private handleTossIn(
    ...
    const tossedCard = newState.discardPile[0];
