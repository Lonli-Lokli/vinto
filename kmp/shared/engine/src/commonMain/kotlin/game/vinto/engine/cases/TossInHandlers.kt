 ...
 *
 * Ported from `packages/engine/src/lib/cases/player-toss-in-finished.ts`.
 */
 ...
 *
 * Ported from `packages/engine/src/lib/cases/execute-jack-swap.ts`.
 */
 ...
 *
 * Ported from `packages/engine/src/lib/cases/execute-queen-swap.ts`.
 */
