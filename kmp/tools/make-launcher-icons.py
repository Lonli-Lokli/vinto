...
The source is `apps/vinto/public/favicon.png` — the orange V the web app already ships,
...
Run from anywhere:
    ...
    python3 kmp/tools/make-launcher-icons.py

It rewrites `kmp/composeApp/src/androidMain/res/mipmap-*`. Re-run it when the mark
...
SOURCE = ROOT / "apps" / "vinto" / "public" / "favicon.png"
RES = ROOT / "kmp" / "composeApp" / "src" / "androidMain" / "res"
