 ...
 *
 * Ported from `legacy-web/packages/engine/src/lib/cases/finish-toss-in.ts`.
 */
 ...
 *
 * Ported from `legacy-web/packages/engine/src/lib/cases/set-next-draw-card.ts`.
 */
 ...
 *
 * Ported from `legacy-web/packages/engine/src/lib/cases/swap-hand-with-deck.ts`.
 */
