 ...
 *
 * Ported from `legacy-web/packages/bot/src/lib/bot-memory.ts`, with two things injected that were
 * ambient there:
 *
 ...
 *
 * Ported from `legacy-web/packages/bot/src/lib/mcts-score-estimator.ts`.
 */
