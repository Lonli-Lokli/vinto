...
enum class CardAction(val serialName: String) {
    ...
    @SerialName("peek-opponent")
    PEEK_OPPONENT("peek-opponent"),

    @SerialName("peek-and-swap")
    PEEK_AND_SWAP("peek-and-swap"),

    @SerialName("swap-cards")
    SWAP_CARDS("swap-cards"),

    @SerialName("force-draw")
    FORCE_DRAW("force-draw"),

    @SerialName("declare-action")
    DECLARE_ACTION("declare-action"),
}
...
enum class GameSubPhase(val serialName: String) {
    ...
    @SerialName("ai_thinking")
    AI_THINKING("ai_thinking"),

    @SerialName("toss_queue_active")
    TOSS_QUEUE_ACTIVE("toss_queue_active"),

    @SerialName("toss_queue_processing")
    TOSS_QUEUE_PROCESSING("toss_queue_processing"),
}

@Serializable
enum class ActionPhase(val serialName: String) {
    @SerialName("choosing-action")
    CHOOSING_ACTION("choosing-action"),

    @SerialName("selecting-target")
...
enum class TargetType(val serialName: String) {
    ...
    @SerialName("opponent-card")
    OPPONENT_CARD("opponent-card"),

    @SerialName("peek-then-swap")
    PEEK_THEN_SWAP("peek-then-swap"),
