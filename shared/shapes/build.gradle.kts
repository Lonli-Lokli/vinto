...
val generatePrngVectorsSource =
    tasks.register<GeneratePrngVectorsSource>("generatePrngVectorsSource") {
        ...
        // The Gradle root is the repository root, so the shared fixtures sit beside it.
        vectorsFile.set(rootProject.layout.projectDirectory.file("fixtures/prng/vectors.json"))
