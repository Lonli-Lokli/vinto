 ...
 * Solution: Add the package path prefix (e.g., "legacy-web/packages/engine/src/index.ts")
 *
...
lcovFiles.forEach(lcovPath => {
  ...
  // Prefixed with legacy-web/: Codecov matches these paths against the repository tree, and
  // this workspace is no longer the repository root.
  const packagePrefix = `legacy-web/packages/${packageName}/`;
  ...
  // Replace SF:src\ or SF:src/ with SF:legacy-web/packages/engine/src/
