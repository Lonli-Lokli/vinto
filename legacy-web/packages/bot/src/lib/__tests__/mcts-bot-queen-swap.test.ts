...
describe('MCTS Bot - Queen Swap (Simplified)', () => {
  ...
  it('should include bot when opponent has known Joker', async () => {
    ...
    console.log('\nQueen swap decision (known Joker):');
  ...
  it('should include bot when not all own cards are known', async () => {
    // Scenario: Bot has drawn Queen but doesn't know all his cards
    // Bot should prefer to peek at least one of his own cards to gain information
    ...
    console.log('\nQueen swap decision (unknown own cards):');
    console.log('  Targets:', decision.targets);
    console.log(
  ...
  it('should include bot when opponent has known low-value card', async () => {
    ...
    // Bot should prefer to peek his card + low card, then swap to steal it
    ...
    console.log('\nQueen swap decision (known low card):');
    console.log('  Targets:', decision.targets);
    console.log('  Bot targets:', botTargets.length);
    console.log('  Human targets:', humanTargets.length);
    console.log('  Should swap:', decision.shouldSwap);
