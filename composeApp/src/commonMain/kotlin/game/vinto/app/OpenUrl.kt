 ...
 *
 * Every caller is the same kind of thing — a page that belongs to the game but is not *in*
 * the game: the privacy policy, the terms, the way to get in touch, the studio's page for this
 * app, and the card game this one is an unofficial client of. Each is a page somebody may want
 * to keep open, mail to themselves, or read properly; none of them is worth an in-app browser,
 * which would mean shipping a second rendering engine to display five documents.
 *
