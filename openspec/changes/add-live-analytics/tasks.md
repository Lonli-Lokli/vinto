...
- [ ] 5.4 **BLOCKED** on time rather than on a dependency now: the deployed room exists and is open (README §6q), so the week of real traffic this needs can start accumulating. Once a week of real traffic exists: revisit the sampling rates in §A8 against actual
